...
with col1:
    ...
    tempos = ['Não atuo', 'De 0 a 6 meses', 'De 6 meses a 1 ano', 'De 1 ano a 2 anos',
...
if proba > 0.7:
    ...
    st.error(f"Você não está nada feliz! Probabilidade: {100 * proba:.0f}%")